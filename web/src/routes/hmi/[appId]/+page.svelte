<script lang="ts">
  ...
  async function seedDemo() {
    ...
    try {
      ...
      await refresh();
      goto(`/hmi/${encodeURIComponent(appId)}/screens/${screenId}`);
    } finally {
      seeding = false;
    }
  }
...
<section class="page">
  <header class="page-header">
    <div>
      <a href="/hmi" class="back">&larr; HMI Apps</a>
      {#if app}
        <h1>{app.name}</h1>
    ...
    <div class="header-actions">
      <a href="/hmi/udts" class="link-btn">UDT Browser &rarr;</a>
  ...
  {:else}
      ...
      {:else}
        <ul class="card-list">
          {#each screens as scr (scr.screenId)}
            <li class="card">
              <a href="/hmi/{encodeURIComponent(appId)}/screens/{encodeURIComponent(scr.screenId)}">
    ...
    <section class="block">
      <header class="block-header">
        <h2>Components</h2>
        <a href="/hmi/udts" class="link-btn small">Create from UDT &rarr;</a>
      </header>
