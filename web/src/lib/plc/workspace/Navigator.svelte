					...
					{#each taskEntries as task (task.name)}
						<li>
							<button
								type="button"
								class="item"
								class:selected={workspaceSelection.isSelected('task', task.name)}
					...
					{#each programEntries as program (program.name)}
						<li>
							<button
								type="button"
								class="item"
								class:selected={workspaceSelection.isSelected('program', program.name)}
								onclick={() => workspaceSelection.select('program', program.name)}
