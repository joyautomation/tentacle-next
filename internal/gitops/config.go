...
var configSchema = []config.FieldDef{
	...
	{EnvVar: "GITOPS_SSH_KEY_PATH", Label: "SSH Key Path", Type: "string", Default: "/var/lib/tentacle/.ssh/id_ed25519", Description: "Path to SSH private key for git auth", Group: "Authentication", GroupOrder: 1, SortOrder: 0},
	// Sync group
...
func loadConfig(b bus.Bus) gitopsConfig {
	...
	return gitopsConfig{
		...
		SSHKeyPath:   get("GITOPS_SSH_KEY_PATH", "/var/lib/tentacle/.ssh/id_ed25519"),
